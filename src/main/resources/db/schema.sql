...
alter table rf.role 
add constraint role_name_uniq
unique(name);

--Rank
create sequence rf.rank_seq start with 10;
create table rf.rank (
    id int generated by default as sequence rank_seq primary key,
    name varchar(255),
    caption varchar(255)
);
alter table rf.rank 
add constraint rank_name_uniq
unique(name);
...
create table rf.person (
    ...
    rank_id int references rf.rank(id),
