...
public interface CrudDao<T extends Entity> {
    ...
    /**
     * Persists a given entity assuming it's new and sets the primary key (id) to the new value.
     * Note that the passed entity id will be ignored. It will not be used as a primary key to insert and will be overwritten.
     * @param t an entity to insert
